...
public class FavoriteController {
    ...
    public ResponseEntity<List<FavoriteResponse>> getFavorites(@AuthenticationPrincipal LoginMember loginMember, @PageableDefault(size = 5, direction = Sort.Direction.ASC) Pageable page) {
